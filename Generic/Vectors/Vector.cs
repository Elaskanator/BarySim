...
namespace Generic.Vectors {
	...
	public class VectorDouble : IVectorDouble {
		public virtual double[] Coordinates { get; protected set; }
		...
		public static VectorDouble operator + (VectorDouble v1, IVectorDouble v2) { return v1.Addition(v2); }
		public static VectorDouble operator - (VectorDouble v1, IVectorDouble v2) { return v1.Subtract(v2); }
