...
namespace ParticleSimulator {
	public static class Parameters {
		...
		public const double WORLD_SCALE = 1600d;
		...
		public const double BOIDS_PREDATOR_COHESION_WEIGHT	= 0.1000d;
		public const double BOIDS_PREDATOR_SEPARATION_WEIGHT= 0.1000d;
